...
* Sie können auch ein [vertrauliches Issue in diesem Repository erstellen](https://gitlab.opencode.de/bmi/ozg-rahmenarchitektur/ozgsec/ozgsec-info/-/issues/new?issue[confidential]=on&issuable_template=security-advisory).
