...
type Artifact struct {
	...
	// required format.
	LastModifiedTimeUtc *string `json:"lastModifiedTimeUtc,omitempty" yaml:"lastModifiedTimeUtc,omitempty" mapstructure:"lastModifiedTimeUtc,omitempty"`
...
type ExternalProperties struct {
	...
	// A stable, unique identifer for this external properties object, in the form of
	// a GUID.
	...
	// A stable, unique identifer for the run associated with this external properties
...
type ExternalPropertyFileReference struct {
	// A stable, unique identifer for the external property file in the form of a
	// GUID.
	Guid *string `json:"guid,omitempty" yaml:"guid,omitempty" mapstructure:"guid,omitempty"`
...
type Invocation struct {
	...
	EndTimeUtc *string `json:"endTimeUtc,omitempty" yaml:"endTimeUtc,omitempty" mapstructure:"endTimeUtc,omitempty"`
	...
	StartTimeUtc *string `json:"startTimeUtc,omitempty" yaml:"startTimeUtc,omitempty" mapstructure:"startTimeUtc,omitempty"`
...
type Notification struct {
	...
	TimeUtc *string `json:"timeUtc,omitempty" yaml:"timeUtc,omitempty" mapstructure:"timeUtc,omitempty"`
}
...
type Result struct {
	...
	// with this result.
	RuleIndex int `json:"ruleIndex" yaml:"ruleIndex" mapstructure:"ruleIndex"`
...
func (j *CodeFlow) UnmarshalJSON(b []byte) error {
	...
	if v, ok := raw["threadFlows"]; !ok || v == nil {
...
func (j *ConfigurationOverride) UnmarshalJSON(b []byte) error {
	...
	if v, ok := raw["descriptor"]; !ok || v == nil {
...
type ThreadFlowLocation struct {
	...
	// executed.
	ExecutionTimeUtc *string `json:"executionTimeUtc,omitempty" yaml:"executionTimeUtc,omitempty" mapstructure:"executionTimeUtc,omitempty"`
...
func (j *Invocation) UnmarshalJSON(b []byte) error {
	...
	if v, ok := raw["executionSuccessful"]; !ok || v == nil {
...
func (j *Edge) UnmarshalJSON(b []byte) error {
	...
	if v, ok := raw["sourceNodeId"]; !ok || v == nil {
		return fmt.Errorf("field sourceNodeId in Edge: required")
	}
	if v, ok := raw["targetNodeId"]; !ok || v == nil {
...
func (j *Fix) UnmarshalJSON(b []byte) error {
	...
	if v, ok := raw["artifactChanges"]; !ok || v == nil {
	...
	if len(plain.ArtifactChanges) < 1 {
...
func (j *Attachment) UnmarshalJSON(b []byte) error {
	...
	if v, ok := raw["artifactLocation"]; !ok || v == nil {
...
func (j *ArtifactChange) UnmarshalJSON(b []byte) error {
	...
	if v, ok := raw["replacements"]; !ok || v == nil {
...
func (j *Replacement) UnmarshalJSON(b []byte) error {
	...
	if v, ok := raw["deletedRegion"]; !ok || v == nil {
...
type ResultProvenance struct {
	...
	// format.
	FirstDetectionTimeUtc *string `json:"firstDetectionTimeUtc,omitempty" yaml:"firstDetectionTimeUtc,omitempty" mapstructure:"firstDetectionTimeUtc,omitempty"`
	...
	// required format.
	LastDetectionTimeUtc *string `json:"lastDetectionTimeUtc,omitempty" yaml:"lastDetectionTimeUtc,omitempty" mapstructure:"lastDetectionTimeUtc,omitempty"`
...
type RunAutomationDetails struct {
	...
	// A stable, unique identifer for this object's containing run object in the form
	// of a GUID.
	Guid *string `json:"guid,omitempty" yaml:"guid,omitempty" mapstructure:"guid,omitempty"`
...
type VersionControlDetails struct {
	...
	AsOfTimeUtc *string `json:"asOfTimeUtc,omitempty" yaml:"asOfTimeUtc,omitempty" mapstructure:"asOfTimeUtc,omitempty"`
...
func (j *VersionControlDetails) UnmarshalJSON(b []byte) error {
	...
	if v, ok := raw["repositoryUri"]; !ok || v == nil {
...
func (j *Run) UnmarshalJSON(b []byte) error {
	...
	if len(plain.NewlineSequences) < 1 {
...
type Sarif210JsonVersion string

var enumValues_Sarif210JsonVersion = []interface{}{
	"2.1.0",
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *Sarif210JsonVersion) UnmarshalJSON(b []byte) error {
	var v string
	if err := json.Unmarshal(b, &v); err != nil {
		return err
	}
	var ok bool
	for _, expected := range enumValues_Sarif210JsonVersion {
		if reflect.DeepEqual(v, expected) {
			ok = true
			break
		}
	...
	if !ok {
		return fmt.Errorf("invalid value (expected one of %#v): %#v", enumValues_Sarif210JsonVersion, v)
	}
	*j = Sarif210JsonVersion(v)
	return nil
}

const Sarif210JsonVersionA210 Sarif210JsonVersion = "2.1.0"

// Static Analysis Results Format (SARIF) Version 2.1.0 JSON Schema: a standard
// format for the output of static analysis tools.
type Sarif210Json struct {
	...
	Version Sarif210JsonVersion `json:"version" yaml:"version" mapstructure:"version"`
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *Sarif210Json) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if v, ok := raw["runs"]; !ok || v == nil {
		return fmt.Errorf("field runs in Sarif210Json: required")
	}
	if v, ok := raw["version"]; !ok || v == nil {
		return fmt.Errorf("field version in Sarif210Json: required")
	}
	type Plain Sarif210Json
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = Sarif210Json(plain)
	return nil
}
