...
The latest patches, security updates and the latest software are published on the `main` branch. For productive use: [release](https://gitlab.opencode.de/bmi/ozg-rahmenarchitektur/ozgsec/ozgsec-helm-chart/-/packages/) (tag).
...
* You can also create a [confidential issue in this repository](https://gitlab.opencode.de/bmi/ozg-rahmenarchitektur/ozgsec/ozgsec-helm-chart/-/issues/new?issue[confidential]=on&issuable_template=security-advisory-en).
